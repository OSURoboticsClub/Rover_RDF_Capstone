...
This branch of the capstone project is used to track the development of libraries and files required to run kalman filters on an ARM Cortex-M0+ based microcontroller. The actual project will end up using a RP2040, but for testing and dev purposes, a feather M0 is being used.
